...
Function Vector_RotationEntity(ent,v.vector)
	RotateEntity ent,v\x,v\y,v\z
End Function

Function Vector_Set_Entity_Pos(ent,v.Vector)
v\x=EntityX(ent)
v\y=EntityY(ent)
v\z=EntityZ(ent)
End Function 

Function Vector_Set_Entity_Rot(ent,v.Vector)
v\x=EntityPitch(ent)
v\y=EntityYaw(ent)
v\z=EntityRoll(ent)
End Function

Function Vector_Swap(v1.Vector,v2.Vector)
	t.Vector=Vector(v1\x,v1\y,v1\z)
